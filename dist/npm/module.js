...
function prepare$1(profile, allowUnassigned, input = '') {
...
function nameprep(str, allowUnassigned = true) {
    return prepare$1(NamePrepProfile, allowUnassigned, str);
}
...
function nodeprep(str, allowUnassigned = true) {
    return prepare$1(NodePrepProfile, allowUnassigned, str);
}
...
function resourceprep(str, allowUnassigned = true) {
    return prepare$1(ResourcePrepProfile, allowUnassigned, str);
}
...
function saslprep(str, allowUnassigned = false) {
    return prepare$1(SASLPrepProfile, allowUnassigned, str);
}
...
const NS_DISCO_EXTERNAL_2 = 'urn:xmpp:extdisco:2';
// XEP-0221
...
class ICESession extends JingleSession {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const all = (changes.contents || []).map(content => {
                ...
                const results = (content.transport.candidates || []).map((json) => __awaiter(this, void 0, void 0, function* () {
                    const candidate = SDP.writeCandidate(convertCandidateToIntermediate(json));
    ...
    onIceCandidate(e) {
        ...
        const candidate = SDP.parseCandidate(e.candidate.candidate);
        const jingle = {
            contents: [
                {
                    creator: JingleSessionRole.Initiator,
...
const Protocol$y = [...ice(NS_JINGLE_ICE_0), ...ice(NS_JINGLE_ICE_UDP_1)];
...
const WS_OPEN = 1;
class WSConnection extends Duplex {
    constructor(client, sm, stanzas) {
        super({ objectMode: true });
        this.sm = sm;
        this.stanzas = stanzas;
...
class Client extends EventEmitter {
    ...
    _getConfiguredCredentials() {
        ...
        const requestedJID = parse$2(this.config.jid || '');
...
export { Client, Constants, JID, index$3 as JXT, index$1 as Jingle, Namespaces, RTT, index$2 as SASL, index as Stanzas, Utils, VERSION, core, createClient, getHostMeta };
